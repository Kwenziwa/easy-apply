    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <!-- Create Button -->
                <a href="{{ route('my-documents.create') }}" class="btn btn-primary" style="float: right;">Add Subject</a>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <form id="delete-form-{{ $document->id }}"
                                        action="{{ route('my-documents.destroy', $document->id) }}" method="POST">


                                        <a href="{{ route('my-documents.destroy',$document->id) }}"

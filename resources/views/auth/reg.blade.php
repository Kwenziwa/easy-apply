                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form method="POST" action="{{ route('register') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="first_name" type="text" placeholder="Enter first_name"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="middle_name" type="text" placeholder="Enter middle_name"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="last_name" type="text" placeholder="Enter last_name"
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Already have an account ? <a
                                                href=" @if (Route::has('login')){{ route('login') }} @endif"
